# ExpressJobs Monetization Plan

`PRODUCTION_STATUS=NO-GO_PRODUCTION`

## MVP Model

- Suggested commission: 15% per completed job.
- Featured jobs for clients.
- Premium worker visibility.
- Company plan for recurring job volume.
