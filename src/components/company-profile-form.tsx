  ...
  return (
    <form className="grid gap-4 rounded-md border border-[var(--line)] bg-white p-5" onSubmit={handleSubmit}>
      <div className="flex items-center gap-2">
        ...
        <p className="text-sm font-bold text-[var(--muted)]">Datos visibles para publicar y gestionar postulantes.</p>
      </div>
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <label className="grid gap-2 text-sm font-bold">
          Tipo de cuenta
          <select className="focus-ring rounded-md border border-[var(--line)] px-3 py-2 font-normal" name="companyType">
      ...
      <label className="grid gap-2 text-sm font-bold">
        Descripcion
        <textarea className="focus-ring min-h-28 rounded-md border border-[var(--line)] px-3 py-2 font-normal" name="description" />
      </label>
      {message ? (
...
function Field({ label, name, placeholder }: { label: string; name: string; placeholder: string }) {
  return (
    <label className="grid gap-2 text-sm font-bold">
      {label}
      <input className="focus-ring rounded-md border border-[var(--line)] px-3 py-2 font-normal" name={name} placeholder={placeholder} />
    </label>
  );
}
